...
class HomophilyContentCNNFM(nn.Module):
    def __init__(self,
                 node2vec_embedding,
        ...
        super(HomophilyContentCNNFM, self).__init__()
    ...
    def forward(self, user_content, user_emb, user_emb_offsets, section_content, section_emb, section_emb_offsets):
        return self.pred(user_content, user_emb, user_emb_offsets, section_content, section_emb, section_emb_offsets)
